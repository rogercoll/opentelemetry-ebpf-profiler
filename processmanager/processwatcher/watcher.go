...
// Package processwatcher defines the listener interfaces through which
// process-lifecycle events are delivered from the process manager to
// extensions (probes, reporters, enrichers, …).
//
// The package is a deliberate leaf: it only imports libpf and process so
// that any package — including reporter — can implement the interfaces
// without an import cycle back through processmanager.
package processwatcher // import "go.opentelemetry.io/ebpf-profiler/processmanager/processwatcher"
